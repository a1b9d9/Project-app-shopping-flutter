    ...
    return BlocConsumer<ShopLoginCubit, ShopLoginStates>(
      listener: (context, state) {
        if (state is ShopLoginErrorState) {
          toast(message: ShopLoginCubit.get(context).info.message, state: ToastColor.error,);
        } else if(state is ShopLoginSuccessState) {
          toast(message: ShopLoginCubit.get(context).info.message, state: ToastColor.success,);


          naviAndExit(context,HomeShop());
        }
      },

      builder: (context, state) {
        var bloc = ShopLoginCubit.get(context);
        return Scaffold(
                          ...
                          children: [
                            ...
                            TextButton(
                                ...
                                child: Text(
                                  "REGISTER",
                                  style:
                                      TextStyle(color: defaultColorLogIn),
                                ))
                          ],
                        ),
                      ]),
